...
namespace Application\RelationsBundle\Twig\Extensions;

class ApplicationRelationsExtension extends \Twig_Extension
{
    ...
    {
        return 'application_relations_twig_extension';
    }
}
