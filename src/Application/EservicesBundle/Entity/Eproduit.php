...
use Application\EservicesBundle\Entity\EproduitImage;
...
class Eproduit {
 ...
 /**
     * @var \Projet
     *
     * @ORM\ManyToOne(targetEntity="EproduitImage", inversedBy="idproduit",cascade={"persist"})
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="idimage", nullable=true,referencedColumnName="id",nullable=true,onDelete="set null")
     * })
     */
    protected $image;
