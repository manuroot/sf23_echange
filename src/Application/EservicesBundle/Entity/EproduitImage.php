...
/**
 * Image de produit
* @ORM\Table(name="eproduit_images")
 * @ORM\Entity(repositoryClass="Application\EservicesBundle\Repository\EproduitImageRepository")
...
// * @Orm\MappedSuperclass
    ...
    protected $temp;
      ...
      /**
       *  @ORM\OneToMany(targetEntity="Application\EservicesBundle\Entity\Eproduit",mappedBy="image",cascade={"persist"})
       */
    protected $idproduit;
     ...
     */
    protected $createdAt;
    protected $disk_path = 'uploads/eproduits';
     ...
     * 
     */
    public function setDiskPath($disk_path = 'uploads/eproduits') {
     ...
     * Add idproduit
     *
     * @param \Application\EservicesBundle\Entity\Eproduit $idproduit
     * @return EproduitImage
     */
    public function addIdproduit(\Application\EservicesBundle\Entity\Eproduit $idproduit)
    {
     ...
     * @param \Application\EservicesBundle\Entity\Eproduit $idproduit
     */
    public function removeIdproduit(\Application\EservicesBundle\Entity\Eproduit $idproduit)
    {
